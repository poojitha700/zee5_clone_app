...
import "./slider.css";
import Block1 from "../BlockComp/Block1";
  ...
  return (
    <Fragment>
      <Carousel infiniteLoop centerMode autoPlay>
        <div>
          <img src="slider_images/slider1.webp" alt="slider1" />
        ...
        <div>
          <img src="slider_images/slider2.webp" alt="slider2" />
          <div className="legend">
        ...
        <div>
          <img src="slider_images/slider3.webp" alt="slider3" />
          <div className="legend">
            <h2>Gattimela </h2>
            <p className="movie_list">
              <span>Movies</span>
        ...
        <div>
          <img src="slider_images/slider4.webp" alt="slider4" />
          <div className="legend">
            <h2>Radhe </h2>
            <p className="movie_list">
              <span>Movies</span>
        ...
        <div>
          <img src="slider_images/slider5.webp" alt="slider5" />
          <div className="legend">
            <h2>Shadow </h2>
            <p className="movie_list">
              <span>Movies</span>
      ...
      <h2>Top Telugu Shows | First Episode Free </h2>
      <Block1 />
    </Fragment>
  );
};
